        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="/"><i class="menu-icon fa fa-laptop"></i>Dashboard  <?php   ?></a>
                    </li>
                    <li class="menu-title">UI elements</li><!-- /.menu-title -->
                    <li class="">
                        <a href="{{url($baseurl.'/'.'astrologer-list')}}"><i class="fa fa-table"></i> Astrologer List </a>
                    </li>
                    <li class="">
                        <a href="{{url($baseurl.'/'.'puja-list')}}"><i class="fa fa-table"></i> Puja List </a>
                    </li>
                    <li class="">
                        <a href="{{url($baseurl.'/'.'product-list')}}"><i class="ti-email"></i> Product List</a>
                    </li>
                    <li class="">
                        <a href="{{url($baseurl.'/'.'booking-page.html')}}"><i class="ti-email"></i> Booking List</a>
                    </li>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/admin.jpg" alt="User Avatar"> <?php echo Session::get('user_name');?>
                        </a>
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <form method="get" action="{{url('logout')}}">
                                <input type="submit" name="logout" value="Logout" class="nav-link btn btn-danger" style="color: white;" >
                            </form>
                        </div>
                    </div>
