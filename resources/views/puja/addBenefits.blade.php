                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add-Puja-Benefits</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Add </strong> Puja Benefits
                    </div>
                    <div class="card-body card-block">
                        <form id="pujaForm" action="{{url('add-benefits', $pujaDetails->id)}}" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            @csrf
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="status" id="puja_name" name="puja_name" class="form-control-sm form-control">
                                        <option value="{{$pujaDetails->id}}" selected>{{$pujaDetails->puja_name}}</option>
                                    </select>
